...
public class TestMethodOverride {
    public static void main(String[] args) {
        ApplicationContext ac = new ClassPathXmlApplicationContext("methodOverride2.xml");

        FruitPlate bean = (FruitPlate) ac.getBean("fruitTemplate");
        System.out.println(bean.getFruit());
